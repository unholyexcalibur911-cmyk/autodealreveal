...
const Support: React.FC = () => {
  ...
  return (
    <>
      <button
        className="z-50 bg-[#f5f5f5] border bg- text-[#6366f1] flex items-center gap-2 px-6 py-2 rounded-full shadow-lg hover:bg-[#6366f1] hover:text-white transition-all group"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
          <div className="relative bg-[#2b2d42] w-full max-w-4xl px-8 py-10 rounded-lg shadow-xl text-center">
            ...
            >
              ...
              {sent && (
                <div className="text-green-400 mt-2">Support request sent!</div>
              )}
